...
if smiles:
try:
[st.info](http://st.info/)("Processing SMILES input...")
...
if uploaded_file:
try:
[st.info](http://st.info/)("Processing SDF file...")
...
try:
[st.info](http://st.info/)("Calculating molecular descriptors, please wait...")
